			...
			if (new Object() {
				boolean check(Entity _entity) {
					if (_entity instanceof LivingEntity) {
						Collection<EffectInstance> effects = ((LivingEntity) _entity).getActivePotionEffects();
						for (EffectInstance effect : effects) {
							if (effect.getPotion() == GravityMasterPotionEffect.potion)
								return true;
						}
					}
					return false;
				...
				if (!(new Object() {
					...
					if (sourceentity instanceof LivingEntity)
						((LivingEntity) sourceentity)
								.addPotionEffect(new EffectInstance(GravityMasterPotionEffect.potion, (int) 6000, (int) 0, (false), (false)));
				}
			}
			if (new Object() {
				boolean check(Entity _entity) {
			...
			if (new Object() {
				boolean check(Entity _entity) {
					if (_entity instanceof LivingEntity) {
						Collection<EffectInstance> effects = ((LivingEntity) _entity).getActivePotionEffects();
						for (EffectInstance effect : effects) {
							if (effect.getPotion() == SpiritMasterPotionEffect.potion)
								return true;
						}
					}
					return false;
				...
				if (!(new Object() {
					...
					if (sourceentity instanceof LivingEntity)
						((LivingEntity) sourceentity)
								.addPotionEffect(new EffectInstance(SpiritMasterPotionEffect.potion, (int) 6000, (int) 0, (false), (false)));
				}
			}
			if (new Object() {
				boolean check(Entity _entity) {
					if (_entity instanceof LivingEntity) {
						Collection<EffectInstance> effects = ((LivingEntity) _entity).getActivePotionEffects();
						for (EffectInstance effect : effects) {
							if (effect.getPotion() == SmokeMasterPotionEffect.potion)
								return true;
						}
					}
					return false;
				...
				if (!(new Object() {
					...
					if (sourceentity instanceof LivingEntity)
						((LivingEntity) sourceentity)
								.addPotionEffect(new EffectInstance(SmokeMasterPotionEffect.potion, (int) 6000, (int) 0, (false), (false)));
				}
			}
			if (new Object() {
				boolean check(Entity _entity) {
					if (_entity instanceof LivingEntity) {
						Collection<EffectInstance> effects = ((LivingEntity) _entity).getActivePotionEffects();
						for (EffectInstance effect : effects) {
							if (effect.getPotion() == FormMasterPotionEffect.potion)
								return true;
						}
					}
					return false;
				...
				if (!(new Object() {
					...
					if (sourceentity instanceof LivingEntity)
						((LivingEntity) sourceentity)
								.addPotionEffect(new EffectInstance(FormMasterPotionEffect.potion, (int) 6000, (int) 0, (false), (false)));
				}
			}
			if (new Object() {
				boolean check(Entity _entity) {
					if (_entity instanceof LivingEntity) {
						Collection<EffectInstance> effects = ((LivingEntity) _entity).getActivePotionEffects();
						for (EffectInstance effect : effects) {
							if (effect.getPotion() == MindMasterPotionEffect.potion)
								return true;
						}
					}
					return false;
				...
				if (!(new Object() {
					...
					if (sourceentity instanceof LivingEntity)
						((LivingEntity) sourceentity)
								.addPotionEffect(new EffectInstance(MindMasterPotionEffect.potion, (int) 6000, (int) 0, (false), (false)));
				}
			}
