...
public class SilverDustMasterKazhdyiTikVoVriemiaEffiektaProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PowerMod.LOGGER.warn("Failed to load dependency entity for procedure SilverDustMasterKazhdyiTikVoVriemiaEffiekta!");
			return;
		}
