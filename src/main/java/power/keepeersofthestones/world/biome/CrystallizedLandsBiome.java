...
import power.keepeersofthestones.world.features.treedecorators.CrystallizedLandsTrunkDecorator;
import power.keepeersofthestones.world.features.treedecorators.CrystallizedLandsLeaveDecorator;
import power.keepeersofthestones.world.features.treedecorators.CrystallizedLandsFruitDecorator;
...
public class CrystallizedLandsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("power:tree_crystallized_lands", FeatureUtils.register("power:tree_crystallized_lands", Feature.TREE,
						new TreeConfiguration.TreeConfigurationBuilder(
								...
								.decorators(ImmutableList.of(CrystallizedLandsLeaveDecorator.INSTANCE, CrystallizedLandsTrunkDecorator.INSTANCE,
										CrystallizedLandsFruitDecorator.INSTANCE))
								.build()),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("power:brown_mushroom_crystallized_lands", VegetationFeatures.PATCH_BROWN_MUSHROOM,
						List.of(CountPlacement.of(3), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("power:red_mushroom_crystallized_lands", VegetationFeatures.PATCH_RED_MUSHROOM, List.of(CountPlacement.of(3),
						RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
