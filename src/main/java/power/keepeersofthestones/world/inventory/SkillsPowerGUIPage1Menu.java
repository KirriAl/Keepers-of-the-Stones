...
public class SkillsPowerGUIPage1Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SkillsPowerGUIPage1Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PowerModMenus.SKILLS_POWER_GUI_PAGE_1, id);
