...
public class DinoeraDimension extends PowerModElements.ModElement {
	@ObjectHolder("power:dinoera_portal")
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("dinoera_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("dinoera_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
	...
	public void initElements() {
		...
		elements.items.add(() -> new DinoeraItem().setRegistryName("dinoera"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				...
				} else if (entity.world.getDimensionKey() != RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("power:dinoera"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("power:dinoera")));
				} else {
					entity.func_242279_ag();
