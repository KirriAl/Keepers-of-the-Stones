...
public class AcidFeature extends LakeFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("power:acid", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(PowerModBlocks.ACID.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("power:acid", CONFIGURED_FEATURE,
