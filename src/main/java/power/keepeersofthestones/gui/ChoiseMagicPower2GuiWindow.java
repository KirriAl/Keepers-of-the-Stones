...
@OnlyIn(Dist.CLIENT)
public class ChoiseMagicPower2GuiWindow extends ContainerScreen<ChoiseMagicPower2Gui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = ChoiseMagicPower2Gui.guistate;

	public ChoiseMagicPower2GuiWindow(ChoiseMagicPower2Gui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("power:textures/screens/mercury_master.png"));
		this.blit(ms, this.guiLeft + 307, this.guiTop + 60, 0, 0, 16, 16, 16, 16);

		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("power:textures/screens/music_master.png"));
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("power:textures/screens/gravity_master.png"));
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Choose the desired power of the elements", 127, 6, -12829636);
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 33, 56, 20, new StringTextComponent(" Moon"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(0, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 114, 56, 20, new StringTextComponent(" Destruct"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(1, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 60, 56, 20, new StringTextComponent("Space"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(2, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 141, 56, 20, new StringTextComponent("Blood"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(3, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 3, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 127, this.guiTop + 33, 56, 20, new StringTextComponent("Time"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(4, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 4, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 127, this.guiTop + 60, 56, 20, new StringTextComponent("Techolog."), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(5, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 5, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 127, this.guiTop + 114, 56, 20, new StringTextComponent("Explosion"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(6, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 6, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 127, this.guiTop + 87, 56, 20, new StringTextComponent("Teleport."), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(7, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 7, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 87, 56, 20, new StringTextComponent("Creation"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(8, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 8, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 226, this.guiTop + 33, 56, 20, new StringTextComponent("Mist"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(9, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 9, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 226, this.guiTop + 60, 56, 20, new StringTextComponent("Sand"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(10, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 10, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 226, this.guiTop + 87, 56, 20, new StringTextComponent(" Speed"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(11, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 11, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 10, this.guiTop + 168, 93, 20, new StringTextComponent("Previous page"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(12, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 12, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 226, this.guiTop + 114, 56, 20, new StringTextComponent(" Poison"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(13, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 13, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 226, this.guiTop + 141, 56, 20, new StringTextComponent("Magnet"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(14, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 14, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 33, 56, 20, new StringTextComponent("Mushrooms"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(15, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 15, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 60, 56, 20, new StringTextComponent("Mercury"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(16, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 16, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 87, 56, 20, new StringTextComponent("Music"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(17, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 17, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 114, 56, 20, new StringTextComponent("Plague"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(18, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 18, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 127, this.guiTop + 141, 56, 20, new StringTextComponent("Gravity"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(19, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 19, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 316, this.guiTop + 168, 72, 20, new StringTextComponent("Next page"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower2Gui.ButtonPressedMessage(20, x, y, z));
				ChoiseMagicPower2Gui.handleButtonAction(entity, 20, x, y, z);
			}
		}));
	}
}
