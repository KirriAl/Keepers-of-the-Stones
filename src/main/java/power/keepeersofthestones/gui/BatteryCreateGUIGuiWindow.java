...
public class BatteryCreateGUIGuiWindow extends ContainerScreen<BatteryCreateGUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("power:textures/screens/arrow_gui.png"));
		this.blit(ms, this.guiLeft + 75, this.guiTop + 36, 0, 0, 22, 15, 22, 15);
