...
public class BuyAquaPowerGui extends PowerModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public BuyAquaPowerGui(PowerModElements instance) {
		super(instance, 847);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("buy_aqua_power"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, BuyAquaPowerGuiWindow::new));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 191, 35) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (ElementalCoinItem.block == stack.getItem());
				}
			}));
			int si;
			int sj;
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			UpdateToWaterPowerProcedure.executeProcedure(Stream
