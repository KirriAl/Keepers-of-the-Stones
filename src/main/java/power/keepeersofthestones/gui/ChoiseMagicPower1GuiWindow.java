...
@OnlyIn(Dist.CLIENT)
public class ChoiseMagicPower1GuiWindow extends ContainerScreen<ChoiseMagicPower1Gui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = ChoiseMagicPower1Gui.guistate;

	public ChoiseMagicPower1GuiWindow(ChoiseMagicPower1Gui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 33, 56, 20, new StringTextComponent("Fire"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(0, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 60, 56, 20, new StringTextComponent("Air"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(1, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 87, 56, 20, new StringTextComponent("Water"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(2, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 114, 56, 20, new StringTextComponent("Earth"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(3, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 3, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 141, 56, 20, new StringTextComponent("Energy"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(4, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 4, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 136, this.guiTop + 33, 56, 20, new StringTextComponent("Ice"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(5, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 5, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 136, this.guiTop + 60, 56, 20, new StringTextComponent("Lightning"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(6, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 6, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 136, this.guiTop + 87, 56, 20, new StringTextComponent("Sound"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(7, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 7, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 136, this.guiTop + 114, 56, 20, new StringTextComponent("Crystal"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(8, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 8, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 136, this.guiTop + 141, 56, 20, new StringTextComponent("Lava"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(9, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 9, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 235, this.guiTop + 33, 56, 20, new StringTextComponent("Rain"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(10, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 10, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 235, this.guiTop + 87, 56, 20, new StringTextComponent("Ocean"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(11, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 11, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 235, this.guiTop + 114, 56, 20, new StringTextComponent("Greenery"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(12, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 12, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 235, this.guiTop + 60, 56, 20, new StringTextComponent("Tornado"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(13, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 13, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 316, this.guiTop + 168, 72, 20, new StringTextComponent("Next page"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(14, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 14, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 235, this.guiTop + 141, 56, 20, new StringTextComponent("Animals"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(15, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 15, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 33, 56, 20, new StringTextComponent("Metal"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(16, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 16, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 60, 56, 20, new StringTextComponent("Light"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(17, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 17, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 87, 56, 20, new StringTextComponent("Shadow"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(18, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 18, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 114, 56, 20, new StringTextComponent("Vacuum"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(19, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 19, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 325, this.guiTop + 141, 56, 20, new StringTextComponent("Sun"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new ChoiseMagicPower1Gui.ButtonPressedMessage(20, x, y, z));
				ChoiseMagicPower1Gui.handleButtonAction(entity, 20, x, y, z);
			}
		}));
	}
}
