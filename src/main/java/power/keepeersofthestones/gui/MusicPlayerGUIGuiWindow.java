...
public class MusicPlayerGUIGuiWindow extends ContainerScreen<MusicPlayerGUIGui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 50, this.guiTop + 61, 67, 20, new StringTextComponent("Build-In"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 176, this.guiTop + 61, 56, 20, new StringTextComponent("Custom"), e -> {
			if (true) {
