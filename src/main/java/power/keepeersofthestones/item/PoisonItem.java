...
public class PoisonItem extends PowerModElements.ModElement {
	@ObjectHolder("power:poison_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:poison_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:poison_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:poison_boots")
