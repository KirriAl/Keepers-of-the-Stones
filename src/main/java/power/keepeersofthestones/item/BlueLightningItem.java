...
public class BlueLightningItem extends PowerModElements.ModElement {
	@ObjectHolder("power:blue_lightning")
	public static final Item block = null;

	public BlueLightningItem(PowerModElements instance) {
		super(instance, 961);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blue_lightning");
		}
		...
		public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
			...
			BlueLightningUseProcedure.executeProcedure(Stream
