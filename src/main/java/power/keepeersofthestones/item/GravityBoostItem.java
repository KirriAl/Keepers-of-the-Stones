...
public class GravityBoostItem extends PowerModElements.ModElement {
	@ObjectHolder("power:gravity_boost")
	public static final Item block = null;

	public GravityBoostItem(PowerModElements instance) {
		super(instance, 963);
	}
	...
	public static class ItemCustom extends Item {
		...
		public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
			...
			GravityBoostUseProcedure.executeProcedure(Stream
