...
public class EnergiumAxeItem extends PowerModElements.ModElement {
	@ObjectHolder("power:energium_axe")
	public static final Item block = null;

	public EnergiumAxeItem(PowerModElements instance) {
		super(instance, 58);
	}
	...
	public void initElements() {
		...
		}, 1, -2.7999999999999998f, new Item.Properties().group(EnergiumItemGroup.tab)) {
			@Override
