...
import power.keepeersofthestones.entity.renderer.FirebirdFeatherRenderer;
...
public class FirebirdFeatherItem extends PowerModElements.ModElement {
	@ObjectHolder("power:firebird_feather")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_firebird_feather").setRegistryName("projectile_firebird_feather");

	public FirebirdFeatherItem(PowerModElements instance) {
		super(instance, 1002);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FirebirdFeatherRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("firebird_feather");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(FirebirdFeatherItem.block);
		}
