...
public class SpeedItem extends PowerModElements.ModElement {
	@ObjectHolder("power:speed_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:speed_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:speed_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:speed_boots")
