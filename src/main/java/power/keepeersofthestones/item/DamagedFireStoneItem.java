...
public class DamagedFireStoneItem extends PowerModElements.ModElement {
	@ObjectHolder("power:damaged_fire_stone")
	public static final Item block = null;

	public DamagedFireStoneItem(PowerModElements instance) {
		super(instance, 81);
	}
