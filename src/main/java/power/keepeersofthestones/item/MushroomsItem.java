...
public class MushroomsItem extends PowerModElements.ModElement {
	@ObjectHolder("power:mushrooms_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:mushrooms_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:mushrooms_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:mushrooms_boots")
