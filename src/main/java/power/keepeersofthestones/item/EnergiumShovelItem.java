...
public class EnergiumShovelItem extends PowerModElements.ModElement {
	@ObjectHolder("power:energium_shovel")
	public static final Item block = null;

	public EnergiumShovelItem(PowerModElements instance) {
		super(instance, 59);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ShovelItem(new IItemTier() {
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				BigSizeUseProcedure.executeProcedure(Stream
		...
		}.setRegistryName("energium_shovel"));
	}
}
