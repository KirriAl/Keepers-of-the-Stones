...
public class DamagedSunStoneItem extends PowerModElements.ModElement {
	@ObjectHolder("power:damaged_sun_stone")
	public static final Item block = null;

	public DamagedSunStoneItem(PowerModElements instance) {
		super(instance, 100);
	}
