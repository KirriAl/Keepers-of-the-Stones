...
public class MusicItem extends PowerModElements.ModElement {
	@ObjectHolder("power:music_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:music_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:music_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:music_boots")
	public static final Item boots = null;

	public MusicItem(PowerModElements instance) {
		super(instance, 887);
	}
