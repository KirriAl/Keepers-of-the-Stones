...
import power.keepeersofthestones.entity.renderer.BoilingWaterRenderer;
...
public class BoilingWaterItem extends PowerModElements.ModElement {
	@ObjectHolder("power:boiling_water")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_boiling_water").setRegistryName("projectile_boiling_water");

	public BoilingWaterItem(PowerModElements instance) {
		super(instance, 1188);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BoilingWaterRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BoilingWaterItem.block);
		}
