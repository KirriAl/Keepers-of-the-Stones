...
public class PuddleItem extends PowerModElements.ModElement {
	@ObjectHolder("power:puddle")
	public static final Item block = null;

	public PuddleItem(PowerModElements instance) {
		super(instance, 1214);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			PuddleUseProcedure.executeProcedure(Stream
