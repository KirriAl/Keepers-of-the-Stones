...
public class MindItem extends PowerModElements.ModElement {
	@ObjectHolder("power:mind_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:mind_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:mind_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:mind_boots")
	public static final Item boots = null;

	public MindItem(PowerModElements instance) {
		super(instance, 1080);
	}
