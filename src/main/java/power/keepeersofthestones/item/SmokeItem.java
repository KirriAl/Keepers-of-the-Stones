...
public class SmokeItem extends PowerModElements.ModElement {
	@ObjectHolder("power:smoke_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:smoke_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:smoke_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:smoke_boots")
	public static final Item boots = null;

	public SmokeItem(PowerModElements instance) {
		super(instance, 1010);
	}
