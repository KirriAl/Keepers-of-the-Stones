...
import power.keepeersofthestones.entity.renderer.SporesRenderer;
...
public class SporesItem extends PowerModElements.ModElement {
	@ObjectHolder("power:spores")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_spores").setRegistryName("projectile_spores");
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(SporesItem.block);
		}
		...
		public void onEntityHit(EntityRayTraceResult entityRayTraceResult) {
			...
			SporesUseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			SporesUseOnBlockProcedure.executeProcedure(Stream
