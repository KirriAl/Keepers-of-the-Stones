...
public class MercuryItem extends PowerModElements.ModElement {
	@ObjectHolder("power:mercury_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:mercury_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:mercury_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:mercury_boots")
	public static final Item boots = null;

	public MercuryItem(PowerModElements instance) {
		super(instance, 873);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(null)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "power:textures/models/armor/mercury__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
