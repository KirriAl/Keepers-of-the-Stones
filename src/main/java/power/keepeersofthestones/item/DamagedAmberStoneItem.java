...
public class DamagedAmberStoneItem extends PowerModElements.ModElement {
	@ObjectHolder("power:damaged_amber_stone")
	public static final Item block = null;

	public DamagedAmberStoneItem(PowerModElements instance) {
		super(instance, 110);
	}
