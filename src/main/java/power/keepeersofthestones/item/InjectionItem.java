...
public class InjectionItem extends PowerModElements.ModElement {
	@ObjectHolder("power:injection")
	public static final Item block = null;

	public InjectionItem(PowerModElements instance) {
		super(instance, 929);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			InjectionUseOnMeProcedure.executeProcedure(Stream
		...
		public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
			...
			InjectionOnPlayerProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("entity", entity),
