...
public class DamagedDestructionStoneItem extends PowerModElements.ModElement {
	@ObjectHolder("power:damaged_destruction_stone")
	public static final Item block = null;

	public DamagedDestructionStoneItem(PowerModElements instance) {
		super(instance, 103);
	}
