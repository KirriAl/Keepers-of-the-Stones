...
import power.keepeersofthestones.entity.renderer.ElectromagneticPulseRenderer;
...
public class ElectromagneticPulseItem extends PowerModElements.ModElement {
	@ObjectHolder("power:electromagnetic_pulse")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_electromagnetic_pulse").setRegistryName("projectile_electromagnetic_pulse");
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("electromagnetic_pulse");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(ElectromagneticPulseItem.block);
		}
