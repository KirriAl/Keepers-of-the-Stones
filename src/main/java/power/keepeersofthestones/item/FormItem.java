...
public class FormItem extends PowerModElements.ModElement {
	@ObjectHolder("power:form_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:form_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:form_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:form_boots")
	public static final Item boots = null;

	public FormItem(PowerModElements instance) {
		super(instance, 1023);
	}
