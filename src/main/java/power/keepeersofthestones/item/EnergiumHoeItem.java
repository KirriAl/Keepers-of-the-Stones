...
public class EnergiumHoeItem extends PowerModElements.ModElement {
	@ObjectHolder("power:energium_hoe")
	public static final Item block = null;

	public EnergiumHoeItem(PowerModElements instance) {
		super(instance, 60);
	}
	...
	public void initElements() {
		...
		}, 0, -3f, new Item.Properties().group(EnergiumItemGroup.tab)) {
			@Override
