...
public class SandItem extends PowerModElements.ModElement {
	@ObjectHolder("power:sand_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:sand_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:sand_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:sand_boots")
