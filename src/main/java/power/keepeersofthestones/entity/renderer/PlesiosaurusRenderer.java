...
@OnlyIn(Dist.CLIENT)
public class PlesiosaurusRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PlesiosaurusEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPlesiosaurus(), 1.5f) {
