...
public class GoldenCrossbowRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GoldenCrossbowItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<GoldenCrossbowItem.ArrowCustomEntity> {
		...
		@Override
		public void render(GoldenCrossbowItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(GoldenCrossbowItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
