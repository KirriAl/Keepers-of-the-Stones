...
public class TyrannosaurusRexEntity extends PowerModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750208, -65536, new Item.Properties().group(TechnologiesAndArtifactsItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("power:jurassic_jungle").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("power:jurassic_swamp").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 50, 1, 2));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new LookAtGoal(this, PlayerEntity.class, (float) 32));
