...
public class PlesiosaurusEntity extends PowerModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092442, -3407668, new Item.Properties().group(ItemGroup.MISC))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, WaterMobEntity.class, false, true));
