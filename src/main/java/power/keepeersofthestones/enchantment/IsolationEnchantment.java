...
public class IsolationEnchantment extends PowerModElements.ModElement {
	@ObjectHolder("power:isolation")
	public static final Enchantment enchantment = null;

	public IsolationEnchantment(PowerModElements instance) {
		super(instance, 1068);
	}

	@Override
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("isolation"));
	}
