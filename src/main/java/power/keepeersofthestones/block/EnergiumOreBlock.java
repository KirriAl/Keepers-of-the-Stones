...
public class EnergiumOreBlock extends PowerModElements.ModElement {
	@ObjectHolder("power:energium_ore")
	public static final Block block = null;

	public EnergiumOreBlock(PowerModElements instance) {
		super(instance, 52);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("power:energium_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("energium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("power:energium_ore"), configuredFeature);
		}
	}
