...
public class EBAnimalsScreen extends AbstractContainerScreen<EBAnimalsMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Animals"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Mobility"), -162, -49, -12829636);
	}
