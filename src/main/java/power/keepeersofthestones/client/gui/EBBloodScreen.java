...
public class EBBloodScreen extends AbstractContainerScreen<EBBloodMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Blood"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Submission"), -162, -49, -12829636);
	}
