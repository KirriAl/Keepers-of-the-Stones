...
public class EBCrystalScreen extends AbstractContainerScreen<EBCrystalMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Crystal"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Shine"), -162, -49, -12829636);
	}
