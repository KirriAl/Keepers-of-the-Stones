...
public class EBLightScreen extends AbstractContainerScreen<EBLightMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Light"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Glow"), -162, -49, -12829636);
	}
