...
public class EBSpaceScreen extends AbstractContainerScreen<EBSpaceMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Space"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Traveling"), -162, -49, -12829636);
	}
