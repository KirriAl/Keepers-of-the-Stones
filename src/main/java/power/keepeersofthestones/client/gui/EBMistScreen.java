...
public class EBMistScreen extends AbstractContainerScreen<EBMistMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Mist"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Stealth"), -162, -49, -12829636);
	}
