...
public class EBLightningScreen extends AbstractContainerScreen<EBLightningMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Lightning"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Fleeting"), -162, -49, -12829636);
	}
