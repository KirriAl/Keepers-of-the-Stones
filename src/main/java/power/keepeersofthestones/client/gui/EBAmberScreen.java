...
public class EBAmberScreen extends AbstractContainerScreen<EBAmberMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("Class: Additional, Unique"), -162, -85, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Element: Amber"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Replication"), -162, -49, -12829636);
	}
