...
public class EBGreeneryScreen extends AbstractContainerScreen<EBGreeneryMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Greenery"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Stability"), -162, -49, -12829636);
	}
