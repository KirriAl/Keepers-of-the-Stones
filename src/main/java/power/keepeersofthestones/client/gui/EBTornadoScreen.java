...
public class EBTornadoScreen extends AbstractContainerScreen<EBTornadoMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Tornado"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Spinning"), -162, -49, -12829636);
	}
