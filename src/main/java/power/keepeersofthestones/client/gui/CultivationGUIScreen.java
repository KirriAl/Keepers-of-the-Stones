...
public class CultivationGUIScreen extends AbstractContainerScreen<CultivationGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("Select a plant to get"), 124, 6, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 250, this.topPos + 52, 77, 20, new TranslatableComponent("Water lily"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 25, 77, 20, new TranslatableComponent("Oak Sapling"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 169, this.topPos + 52, 77, 20, new TranslatableComponent("Vine"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 88, this.topPos + 25, 77, 20, new TranslatableComponent("Birch Sapling"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 250, this.topPos + 25, 77, 20, new TranslatableComponent("Spruce Sapling"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 169, this.topPos + 25, 77, 20, new TranslatableComponent("Acacia Sapling"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 52, 77, 20, new TranslatableComponent("Dark sapling"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 88, this.topPos + 52, 77, 20, new TranslatableComponent("Jungle sapling"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 79, 77, 20, new TranslatableComponent("Wheat"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 88, this.topPos + 79, 77, 20, new TranslatableComponent("Potato"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 169, this.topPos + 79, 77, 20, new TranslatableComponent("Carrot"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 250, this.topPos + 79, 77, 20, new TranslatableComponent("Beetroot"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 7, this.topPos + 106, 77, 20, new TranslatableComponent("Melon"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 88, this.topPos + 106, 77, 20, new TranslatableComponent("Pumpkin"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 169, this.topPos + 106, 77, 20, new TranslatableComponent("Sugar Cane"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 250, this.topPos + 106, 77, 20, new TranslatableComponent("Bamboo"), e -> {
			if (true) {
