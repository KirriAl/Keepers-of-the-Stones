...
public class EBTimeScreen extends AbstractContainerScreen<EBTimeMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Time"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: History"), -162, -49, -12829636);
	}
