...
public class EBVacuumScreen extends AbstractContainerScreen<EBVacuumMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Vacuum"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Empty"), -162, -49, -12829636);
	}
