...
public class EBSunScreen extends AbstractContainerScreen<EBSunMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Sun"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Healing"), -162, -49, -12829636);
	}
