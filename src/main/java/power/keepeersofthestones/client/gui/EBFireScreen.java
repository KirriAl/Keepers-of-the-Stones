...
public class EBFireScreen extends AbstractContainerScreen<EBFireMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Fire"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Ignition"), -162, -49, -12829636);
	}
