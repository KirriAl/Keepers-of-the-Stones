...
public class EBOceanScreen extends AbstractContainerScreen<EBOceanMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Ocean"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Deepness"), -162, -49, -12829636);
	}
