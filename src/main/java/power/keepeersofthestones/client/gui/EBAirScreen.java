...
public class EBAirScreen extends AbstractContainerScreen<EBAirMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("Element: Air"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Soaring"), -162, -49, -12829636);
	}
