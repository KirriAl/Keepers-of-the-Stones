...
public class BuildingGUIScreen extends AbstractContainerScreen<BuildingGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("Select the structure you want to place"), 28, 11, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 19, this.topPos + 56, 61, 20, new TranslatableComponent("Library"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 118, this.topPos + 29, 77, 20, new TranslatableComponent("Blacksmith"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 19, this.topPos + 29, 87, 20, new TranslatableComponent("Butcher Shop"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 91, this.topPos + 56, 82, 20, new TranslatableComponent("Streetlight"), e -> {
			if (true) {
