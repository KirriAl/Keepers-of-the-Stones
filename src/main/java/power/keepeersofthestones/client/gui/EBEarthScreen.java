...
public class EBEarthScreen extends AbstractContainerScreen<EBEarthMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("Class: Basic"), -162, -85, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Element: Earth"), -162, -67, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("Force: Resistance"), -162, -49, -12829636);
	}
