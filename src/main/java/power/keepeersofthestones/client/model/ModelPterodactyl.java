...
public class ModelPterodactyl<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_r1 = body.addOrReplaceChild("body_r1",
				CubeListBuilder.create().texOffs(0, 91).addBox(-3.0F, -2.5F, -16.0F, 6.0F, 5.0F, 32.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition wing0_r1 = wings.addOrReplaceChild("wing0_r1",
				CubeListBuilder.create().texOffs(40, 0).addBox(-6.0F, -0.5F, -32.0F, 12.0F, 1.0F, 32.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition wing1_r1 = wings.addOrReplaceChild("wing1_r1",
				CubeListBuilder.create().texOffs(40, 0).addBox(-6.0F, -0.5F, 0.0F, 12.0F, 1.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 0.0F, 0.0F, -1.5708F, -1.4835F, 1.5708F));
		...
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(32, 48).addBox(-2.5F, -3.2627F, -10.5379F, 5.0F, 5.0F, 11.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition upper_beak1_r1 = upper_beak.addOrReplaceChild("upper_beak1_r1",
				CubeListBuilder.create().texOffs(3, 41).addBox(-1.5F, -2.1299F, -5.9535F, 3.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition upper_beak0_r1 = upper_beak.addOrReplaceChild("upper_beak0_r1",
				CubeListBuilder.create().texOffs(3, 40).addBox(-2.0F, -2.6299F, -5.9535F, 4.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition lower_beak1_r1 = lower_beak.addOrReplaceChild("lower_beak1_r1",
				CubeListBuilder.create().texOffs(68, 24).addBox(-1.5F, -0.9362F, -8.4905F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition lower_beak0_r1 = lower_beak.addOrReplaceChild("lower_beak0_r1",
				CubeListBuilder.create().texOffs(0, 45).addBox(-1.5F, -0.5436F, -11.499F, 3.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0327F, 0.2507F, 0.0436F, 0.0F, 0.0F));
		PartDefinition crest = head.addOrReplaceChild("crest",
				CubeListBuilder.create().texOffs(109, 117).addBox(-0.5F, -4.0F, -3.5F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -3.3578F, -4.9336F));
		PartDefinition legs0 = partdefinition.addOrReplaceChild("legs0", CubeListBuilder.create(), PartPose.offset(-4.0F, 9.6465F, 18.8826F));
		...
		PartDefinition legs1 = partdefinition.addOrReplaceChild("legs1", CubeListBuilder.create(), PartPose.offset(3.0F, 9.6465F, 18.8826F));
		...
		PartDefinition tail_r1 = tail.addOrReplaceChild("tail_r1",
				CubeListBuilder.create().texOffs(31, 119).addBox(-1.5F, -1.1743F, -0.0076F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0873F, 0.0F, 0.0F));
