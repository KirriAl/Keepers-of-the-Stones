...
public class ModelPlesiosaurus<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(436, 476).addBox(-6.5F, -25.0F, 67.8813F, 14.0F, 12.0F, 24.0F,
		...
		PartDefinition neck_r1 = neck.addOrReplaceChild("neck_r1",
				CubeListBuilder.create().texOffs(0, 300).addBox(-4.5F, -70.3325F, 14.6368F, 10.0F, 64.0F, 10.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition lower_jaw_r1 = lower_jaw.addOrReplaceChild("lower_jaw_r1",
				CubeListBuilder.create().texOffs(64, 484).addBox(-6.5F, -13.0F, 67.8813F, 14.0F, 4.0F, 24.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition body_r1 = body.addOrReplaceChild("body_r1",
				CubeListBuilder.create().texOffs(1, 395).addBox(-17.5F, 3.0F, -64.1187F, 34.0F, 32.0F, 85.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition tail_r1 = tail.addOrReplaceChild("tail_r1",
				CubeListBuilder.create().texOffs(472, 0).addBox(-5.5F, 60.7019F, -12.454F, 10.0F, 40.0F, 10.0F,
						new CubeDeformation(0.0F)),
